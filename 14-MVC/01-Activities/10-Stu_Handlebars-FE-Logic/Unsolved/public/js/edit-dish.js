async function editFormHandler(event) {
  ...
  // if it is checked, it will be true, and it si not checked it will be false
...
// window.location gives us access to the URL. We then use the .split() method to access the number at the end of the URL and set that equal to id.
  ...
  // the controller, this will handle the 'put' request
  ...
  // if the response is ok it was successfully updated.
  if (response.ok) {
